...
short_description: "A dynamic internal AI knowledge base to support learning and quick updates. It accompanies presentations and workshops to provide accurate, real-use case examples of AI in the enterprise."
badges:
  - label: Nuxt
    type: primary
  - label: Typescript
...
To educate our staff, I gave introductory talks on AI, created illustrations and organized workshops. This website is a sort of companion piece to my introductory presentations, allowing people to consult it afterwards and have a solid knowledge base covering the basics that were presented. 
