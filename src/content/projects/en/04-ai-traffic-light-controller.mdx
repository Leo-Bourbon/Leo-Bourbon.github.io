...
short_description: "Application of Reinforcement Learning with Python, StableBaselines3 and Godot on a custom traffic light controller, to optimize throughput of cars at intersections."
badges:
  - label: AI
    type: secondary
  - label: Python
