...
Some highlights are:
- The use of layouts, which allowed me to centralise the logic for handling different screen sizes in one place, for easier maintenance.
- The internationalisation with i18n, which allows me not to duplicate pages for different languages, but only to fill in translation files as needed. This makes it easy to add more languages in the future.
