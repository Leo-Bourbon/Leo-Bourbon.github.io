...
short_description: "Web solution designed to support the existing workflows of Atmo AuRA's engineers when they need to keep up to date with information and research on various topics. Built with a focus on ethics and frugal AI. Powered by a locally hosted LLM."
badges:
  - label: Nuxt
    type: primary
  - label: Typescript
